...
public class ByStreamService {
    ...
    public List<Post> getQuestionPapersByUniversity(String university, String stream, Integer semester){
        List<UserProfile> uniqueUserProfiles = new ArrayList<>();
        List<College> allCollege = collegeRepository.findByUniversityName(university);
        for (College clg : allCollege) {
            Education edu = clg.getEducation();
    ...
    public List<Post> getUpToDateContentsByUniversity(String university, String stream, Integer semester){
        List<UserProfile> uniqueUserProfiles = new ArrayList<>();
        List<College> allCollege = collegeRepository.findByUniversityName(university);
        for (College clg : allCollege) {
            Education edu = clg.getEducation();
    ...
    public List<Post> getWriteUpsByExam(String stream){
        List<UserProfile> uniqueUserProfiles = new ArrayList<>();
    ...
    public List<Post> getQuestionPapersByExam(String stream){
        List<UserProfile> uniqueUserProfiles = new ArrayList<>();
        List<Education> educationList = educationRepository.findBySpecializationStream(stream);
        for (Education education : educationList) {
            uniqueUserProfiles.add(education.getUser());
